    ...
    <footer className="bg-primary-100 py-16">
      <div className="justify-content mx-auto w-5/6 gap-16 md:flex">
        <div className="mt-16 basis-1/2 md:mt-0">
          ...
          <p className="my-5">
            At Evogym, we’re more than just a fitness center—we’re a community
            committed to your success. Whether you're a beginner or a pro, we
            provide state-of-the-art facilities, expert coaching, and a
            supportive environment to help you reach your fitness goals.
          </p>

          <p>© {new Date().getFullYear()} SamVic Gym. All Rights Reserved.</p>
        </div>
